...
EXCLUIR_REGEX='^(\.git|docs|tests|deploy|Identidade Visual|Instruções Site antigo|config\.exemplo\.php|brand-tokens\.css|tokens\.json|CLAUDE\.md|\.gitignore|instalar\.php)'
